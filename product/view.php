      ...
      <!--Use a while loop to make a table row for every DB row-->
        ...
        <tr style="background-color: #C0C0C0;">
          ...
          <button class="btn btn-danger delete" id="<?php echo $row['id']?>"><span class="icon-trash"></span>&nbsp;</button></td>
                ...
                <td>
                  <a href="transactions.php?invoice_number=<?php echo $_GET['invoice_number']?>&med_name=<?php echo $row['medicine_name']?>&exp_date=<?php echo $row['expire_date'] ?>">View Transactions</a>
                </td>
            </tr>
