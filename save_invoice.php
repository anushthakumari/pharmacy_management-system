...
if (isset($_POST['submit'])) {
  ...
  // $pdf->Output(__DIR__ . 'invoices/all_invoices/' . $filename, 'F');
  ...
  if ($insert_query) {
    ...
    if ($update_stock_query) {
      ...
      if ($email) {
        ...
        $mail->Body    = 'Hi There, Please find attached invoice pdf'; //email message

        $mail->AddAttachment($pdf_path, 'attachment.pdf');
